            ...
            children: [
                ...
                child: Row(
                  children: [
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: const [
                      Text('Spring Sale', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                      SizedBox(height: 8),
                      Text('Up to 30% off on selected items', style: TextStyle(fontSize: 12)),
                      SizedBox(height: 8),
                    ])),
                    Container(
                      width: 80,
                      height: 80,
                      child: Image.network('https://cdn-icons-png.flaticon.com/512/833/833314.png', fit: BoxFit.contain),
                    )
                  ],
                ),
              ),
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: categories.map((c) => _CategoryChip(name: c['name'] ?? '')).toList(),
                ),
              ),
              const SizedBox(height: 18),
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: const [
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Image.network(img, fit: BoxFit.cover, width: double.infinity, errorBuilder: (_, __, ___) => const Icon(Icons.broken_image)),
          ),
          const SizedBox(height: 8),
          Text(data['name'] ?? '', style: const TextStyle(fontWeight: FontWeight.bold)),
          const SizedBox(height: 4),
          Text('\$${data['price']}', style: TextStyle(color: Colors.grey[800])),
          const SizedBox(height: 8),
          SizedBox(
